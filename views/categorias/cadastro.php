...
if (isset($_POST['cadastrar'])) {
    ...
    $nome = filter_input(INPUT_POST, "categoria", FILTER_SANITIZE_MAGIC_QUOTES);

    $cat = new Categorias;
    $cat->setIdCat($id);
    $cat->setCatNome($nome);
    $cadastrar = $cat->cadastrar();
}
                    ...
                    <div class="col-lg-6 col-md-6">
                        <form role="form" method="post">
                            <div class="form-group">
                                <label>Código:</label><input class="form-control" name="id" disabled>

                            </div>
                            <div class="form-group">
                                <label>Categoria:</label>
                                <input class="form-control" placeholder="Digite o nome da categoria" name="categoria">
                            </div>
                            <div class="form-group">
